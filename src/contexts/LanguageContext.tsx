...
const translations = {
  es: {
    ...
    'servicesPage.specializedSubtitle': 'Amplia gama de servicios especializados para cubrir todas las necesidades del sector marítimo colombiano.',
    ...
    'contactPage.services.inspection': 'Inspección y Certificación',
    ...
    'contactPage.addressText': 'Carrera 3 No. 46-51, Oficina 905. Marbella\nCartagena de Indias - Colombia',
  ...
  en: {
    ...
    'servicesPage.specializedSubtitle': 'Wide range of specialized services to cover all the needs of the Colombian maritime sector.',
    ...
    'contactPage.services.inspection': 'Inspection and Certification',
    ...
    'contactPage.addressText': 'Carrera 3 No. 46-51, Office 905. Marbella\nCartagena de Indias - Colombia',
